      ...
      <div class="row">
        ...
        <div class="center">
          <div class="row">
            ...
            <!-- End Sales Card -->
            <div class="w3-content w3-section" style="max-width:600px;max-height:200px">
              <img class="mySlides" src="assets/dashboard/1.jpeg" style="width:100%">
              <img class="mySlides" src="assets/dashboard/2.jpeg" style="width:100%">
              <img class="mySlides" src="assets/dashboard/3.jpeg" style="width:100%">
            </div>
    </section>
